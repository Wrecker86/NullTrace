...
Android versions newer than Android 16 may work, but they are not considered supported until they pass the project acceptance checks. Older Android versions are not supported.
...
For reports involving a published APK, include its SHA-256 checksum. For source-level reports, include the affected file and a minimal reproduction or proof of concept. Redact personal data and use disposable identities and test messages.
